...
const (
	...
	WorkflowErrorTypeStateDecision       = "StateDecisionFailingWorkflow"
	WorkflowErrorTypeUserWorkflowError   = "InvalidUserWorkflowCode"
	WorkflowErrorTypeServerInternalError = "ServerInternalError"
