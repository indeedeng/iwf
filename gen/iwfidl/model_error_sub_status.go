...
const (
	UNCATEGORIZED ErrorSubStatus = "ERR_UNCATEGORIZED"
	WORKFLOW_ALREADY_STARTED ErrorSubStatus = "ERR_WORKFLOW_ALREADY_STARTED"
	WORKFLOW_NOT_EXISTS ErrorSubStatus = "ERR_WORKFLOW_NOT_EXISTS"
)

// All allowed values of ErrorSubStatus enum
var AllowedErrorSubStatusEnumValues = []ErrorSubStatus{
	"ERR_UNCATEGORIZED",
	"ERR_WORKFLOW_ALREADY_STARTED",
	"ERR_WORKFLOW_NOT_EXISTS",
}
