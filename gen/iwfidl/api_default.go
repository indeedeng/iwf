...
type DefaultApi interface {
	...
	*/
	...
	/*
		ApiV1WorkflowPersistenceGetPost get workflow data objects

		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@return ApiApiV1WorkflowPersistenceGetPostRequest
	*/
	ApiV1WorkflowPersistenceGetPost(ctx context.Context) ApiApiV1WorkflowPersistenceGetPostRequest

	// ApiV1WorkflowPersistenceGetPostExecute executes the request
	//  @return WorkflowGetPersistenceDataResponse
	ApiV1WorkflowPersistenceGetPostExecute(r ApiApiV1WorkflowPersistenceGetPostRequest) (*WorkflowGetPersistenceDataResponse, *http.Response, error)
...
type ApiApiV1WorkflowPersistenceGetPostRequest struct {
	ctx                               context.Context
	ApiService                        DefaultApi
	workflowGetPersistenceDataRequest *WorkflowGetPersistenceDataRequest
}

func (r ApiApiV1WorkflowPersistenceGetPostRequest) WorkflowGetPersistenceDataRequest(workflowGetPersistenceDataRequest WorkflowGetPersistenceDataRequest) ApiApiV1WorkflowPersistenceGetPostRequest {
	r.workflowGetPersistenceDataRequest = &workflowGetPersistenceDataRequest
	return r
}

func (r ApiApiV1WorkflowPersistenceGetPostRequest) Execute() (*WorkflowGetPersistenceDataResponse, *http.Response, error) {
	return r.ApiService.ApiV1WorkflowPersistenceGetPostExecute(r)
}
...
ApiV1WorkflowPersistenceGetPost get workflow data objects
	...
	@return ApiApiV1WorkflowPersistenceGetPostRequest
*/
func (a *DefaultApiService) ApiV1WorkflowPersistenceGetPost(ctx context.Context) ApiApiV1WorkflowPersistenceGetPostRequest {
	return ApiApiV1WorkflowPersistenceGetPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return WorkflowGetPersistenceDataResponse
func (a *DefaultApiService) ApiV1WorkflowPersistenceGetPostExecute(r ApiApiV1WorkflowPersistenceGetPostRequest) (*WorkflowGetPersistenceDataResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *WorkflowGetPersistenceDataResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.ApiV1WorkflowPersistenceGetPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/workflow/persistence/get"
	...
	// body params
	localVarPostBody = r.workflowGetPersistenceDataRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
