...
```text
+-----------------+-------+-------------------+-------------------+-------+-------------------------------+-------------------------------+-------+
| workflowId      | runId | data object key1  | data object key2  | ...   | keyword search attribute key1 | integer search attribute key2 | ...   |
+-----------------+-------+-------------------+-------------------+-------+-------------------------------+-------------------------------+-------+
| your-wf-id1     | uuid1 | a-custom-value-1  | a-custom-value-4  | ...   | a-custom-text-value1          | 1234                          | ...   |
+-----------------+-------+-------------------+-------------------+-------+-------------------------------+-------------------------------+-------+
| your-wf-id1     | uuid2 | a-custom-value-2  | a-custom-value-5  | ...   | a-custom-text-value2          | 1234                          | ...   |
+-----------------+-------+-------------------+-------------------+-------+-------------------------------+-------------------------------+-------+
| your-wf-id2     | uuid3 | a-custom-value-3  | a-custom-value-6  | ...   | a-custom-text-value3          | 1234                          | ...   |
+-----------------+-------+-------------------+-------------------+-------+-------------------------------+-------------------------------+-------+
|............     | ..... | ................  | ................  | ...   | ....................          | ....                          | ...   |
+-----------------+-------+-------------------+-------------------+-------+-------------------------------+-------------------------------+-------+
```
